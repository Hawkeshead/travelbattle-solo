...
const L=Number(process.argv[3]||1); const BP=Number(process.argv[4]||0), IN=Number(process.argv[5]||0); state.aiConfig={ red:{BRIGADIER_LEAD:L,BRIGADE_PLAN:BP,UNIT_INTENT:IN}, blue:{BRIGADIER_LEAD:L,BRIGADE_PLAN:BP,UNIT_INTENT:IN} };
